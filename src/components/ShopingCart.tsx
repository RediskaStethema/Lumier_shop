...
import type { ShopCartProdType, ShoppingCartTableDataType } from "../utils/types";
            ...
            <Dialog open={dialogOpen} onClose={handleDialogClose} maxWidth="sm" fullWidth>
                ...
                >
                    <Typography sx={{ fontSize: "0.95rem", mb: 2, mt: 1, color: "#8a6e5d" }}>
                        Please make sure you have entered the correct phone number and shipping address in your profile.
